...
## Preliminary thoughs on the addition of 'error'
...
With all the new parameters written into the data frame, a plot of 'weight gain' ans a function of average weight is produced.
...
## Re-create original model using cumulative growth function
